    ...
    def shopify_create_product_data_queue(self, instance, import_based_on='', from_date=False,
        ...
        if template_ids:
            ...
            if import_based_on == "create_date":
                results = shopify.Product().find(created_at_min=from_date, created_at_max=to_date, limit=250)
            else:
                results = shopify.Product().find(updated_at_min=from_date, updated_at_max=to_date, limit=250)
